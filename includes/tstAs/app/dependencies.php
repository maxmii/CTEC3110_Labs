...
$container['Login_validator'] = function ($container) {
    $class_path = $container->get('settings')['class_path'];
    require $class_path . 'LoginValidator.php';
    $validator = new LoginValidator();
    return $validator;
};
$container['Login_model'] = function ($container) {
    $class_path = $container->get('settings')['class_path'];
    require $class_path . 'LoginModel.php';
    $model = new LogiinModel();
    return $model;
};
$container['Login_wrapper'] = function ($container) {
    $class_path = $container->get('settings')['class_path'];
    require $class_path . 'LoginWrapper.php';
    $login_wrapper = new LoginWrapper();
