...
$container['companydetails_model'] = function ($container) {
    $class_path = $container->get('settings')['class_path'];
    require $class_path . 'CompanyDetailsModel.php';
    $model = new CompanyDetailsModel();
    return $model;
};
$container['companydetailschart_model'] = function ($container) {
    $class_path = $container->get('settings')['class_path'];
    require $class_path . 'CompanyDetailsChartModel.php';
    $model = new CompanyDetailsChartModel();
    return $model;
};
